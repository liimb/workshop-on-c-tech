...
hash_table.a: hash_table.o pool_allocator.a
...
test: quadratic_solver_test integral_solver_test singly_linked_list_test stack_test pool_allocator_test linear_allocator_test array_list_test hash_table_test gc_test gc_ctor_dtor_test gc_cyclic_links_test
